...
import static com.ravi.springmvcrest.controllers.v1.AbstractRestControllerTest.asJsonString;
...
class VendorControllerTest {
    ...
    public void updateVendor() throws Exception {
        ...
        given(vendorService.updateVendor(any(), anyLong())).willReturn(vendorDTO_1);
    ...
    public void patchVendor() throws Exception {
        given(vendorService.patchVendor(any(), anyLong())).willReturn(vendorDTO_1);
